<div id="trening-detalji">
	...
	<div id="trening-detalji-info">
		...
		<form method="post" enctype="multipart/form-data">
			...
			<label>Naslov</label>
			<input type="text" name="training_title" value="<?= $training_title ?? '' ?>">

			<label>Opis</label>
			<input type="text" name="training_description" value="<?= $training_description ?? '' ?>">

			<label>Cena</label>
			<input type="text" name="training_price" value="<?= $training_price ?? '' ?>">
