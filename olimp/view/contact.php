<div id="kontakt">
    ...
    <div id="kontakt-forma">
        ...
        <input type="text" id="ime" placeholder="Petar Petrović">

        <label for="trening">Vrsta treninga:</label>
        <select id="trening">
        ...
        <textarea id="poruka" cols="30" rows="10" placeholder="Poruka..."></textarea>

        <button id="posalji-formu">Pošaljite</button>
    </div>
...
<script>
    ...
    var dugme2 = document.getElementById("posalji-formu");
    dugme2.addEventListener("click", posaljiFormu);
    ...
    function posaljiFormu() {
        ...
        console.log("Vrsta treninga: " + trening);
        console.log("Poruka: " + poruka);

        alert("Vaša poruka je poslata, hvala na poverenju!");
    }
</script>