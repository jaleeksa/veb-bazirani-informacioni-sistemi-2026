<div id="naslovna">
    ...
    <div class="naslovna-o-nama">
        <div id="naslovna-on-slika">

        </div>
        <div>
            <h2>O NAMA</h2>
            <p>
                Naša misija je jednostavna, ali snažna – inspirisati, podržati i motivisati ljude da
                postignu svoje
                najviše potencijale kroz vežbanje i održavanje zdravog načina života. Verujemo da je svako u
                stanju
    ...
    <div class="naslovna-treninzi">
        <h2>TRENINZI</h2>
        <h4>Naš tim stručnih trenera posvećen je vašem uspehu. Sa bogatim iskustvom i strašću prema fitnesu, oni
            će vas inspirisati, pružiti podršku i prilagoditi treninge vašim individualnim potrebama.</h4>
        <table>
            <tr>
